...
def exibir_extrato(clientes):
    ...
    extrato = ""
    if not transacoes:
        extrato = "Conta sem movimentações."
    else:
        for transacao in transacoes:
            extrato += f"\n{transacao['tipo']:>10}:\tR$ {transacao['valor']:>15.2f}\tData e Hora {transacao['data']}"

    print(extrato)
    print(f"\n\033[92mSaldo :\tR$ {conta.saldo:.2f}")
    print("\033[39m==========================================================================")
...
def criar_cliente(clientes):
    ...
    if cliente:
        print("\n|/\/\/\/\| Este CPF está cadastrado com outro cliente |/\/\/\/\|")
        return
